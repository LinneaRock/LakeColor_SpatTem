...
write.csv(temporal_avg_lms,"/project/lakecolor/data/02_Color_Climate_Landcover_Trends/2024-08-02_lake_color_linear_models.csv")
...
cd /project/lakecolor/data/02_Color_Climate_Landcover_Trends
module load arcc/1.0  gcc/12.2.0 
module load r/4.4.0
...
## 1a. Removing lakes that have dominant wavelengths outside of 470-590 for >5 observations. 25 lakes were removed from the analyses.
```{r}
require(tidyverse)
temporal<-read.csv("/project/lakecolor/data/02_Color_Climate_Landcover_Trends/2024-08-02_lake_color_linear_models.csv", header=T,row.names=1)
nrow(temporal)
# 2600058
...
write.csv(temporal,"/project/lakecolor/data/02_Color_Climate_Landcover_Trends/2024-08-29_lake_color_linear_models.csv")
...
write.csv(prism_trends,"/project/lakecolor/data/02_Color_Climate_Landcover_Trends/2024-08-02_Prism_climate_trends.csv")
```
...
prism<-read.csv("/project/lakecolor/data/02_Color_Climate_Landcover_Trends/2024-08-02_Prism_climate_trends.csv", header=T,row.names=1)

# read in temporal trend data
trends<-read.csv("/project/lakecolor/data/02_Color_Climate_Landcover_Trends/2024-08-29_lake_color_linear_models.csv", header=T, row.names=1)
...
black_points <- trends_prism_landcover %>% filter(avg_dwl_site > 590)
# no points that have an average dwl that is outside the color range

write_rds(trends_prism_landcover,"/project/lakecolor/data/02_Color_Climate_Landcover_Trends/2024-08-29_lakecolor_climate_landcover_trends.rds")
```
...
```{bash}
chmod a-w *
cp 2024-08-29_lakecolor_climate_landcover_trends.rds ..
```
