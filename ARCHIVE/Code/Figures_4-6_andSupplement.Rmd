...
nrow(lk[lk$lake_waterarea_ha<10,])
# small 43228
...
lake_color_long <- lake_color %>%
  pivot_longer(cols = c("soil_orgcarbon_gperkg", "soil_clay_pct", "groundwaterrecharge_mmperyr", "soil_sand_pct"), 
               names_to = "variable", 
               values_to = "value")
...
lake_color_long$variable<-factor(lake_color_long$variable, levels=c("Soil organic carbon (g/kg)","Soil clay (%)","Groundwater recharge (mm/yr)", "Soil sand (%)"))
...
# Reshape data to long format
lake_color_long <- lake_color %>%
  pivot_longer(cols = c("lake_perimeter_m", "ws_area_ha", "lake_elevation_m", "lake_waterarea_ha", "lake_lat_decdeg"), 
               names_to = "variable", 
               values_to = "value")
...
ggboxplot(lake_color_long, x = "basic_trend_cat", y = "value", 
          facet.by = "variable",scales = "free_y") +
  stat_compare_means(method = "wilcox.test", 
                     comparisons = list(
                       c("Trending green", "No trend"),
                       c("Trending green", "Trending blue"),
                       c("Trending blue", "No trend")
                     ),
                     label = "p.signif") + custom_theme() +
        theme(axis.title.x = element_blank())

ggsave("/Users/jordanscheibe/Library/CloudStorage/OneDrive-UniversityofWyoming/Collaborations/LakeColor/LakeColor_SpatTem/Figures/Figure5/Figure5_Wilcox_result_trends.png",width=15, height=9, units="in",dpi = 200)
...
lake_color_long$variable<-factor(lake_color_long$variable, levels=c("Lake elevation (m)","log(Lake area (ha))",
"log(Watershed area (ha))","log(Lake perimeter (m))","Latitude (DD)"))
...
mean_totaldepnitrogen_kgperha   mean_totaldepsulfur_kgperha 
                   -0.2640571                    -0.2738698 
[1] "Principal component 2"
        avg_nlcd_forest_pct groundwaterrecharge_mmperyr              runoff_inperyr               soil_clay_pct 
                  0.2684642                   0.3138799                   0.2985303                  -0.2638211 
      soil_orgcarbon_gperkg 
                  0.2889508 
[1] "Principal component 3"
avg_nlcd_wetland_pct          soil_kffact        soil_sand_pct        soil_silt_pct   topographicwetness 
          -0.2777025            0.3431388           -0.3078798            0.3155079           -0.3006215 
[1] "Principal component 4"
[1] 0.2656759
[1] "Principal component 5"
    lake_lat_decdeg       avg_temp_degC    avg_nlcd_dev_pct satoverlandflow_pct        roads_mperha 
          0.2948483          -0.2768760           0.2724737          -0.2802724           0.2729229 
[1] "Principal component 6"
        lake_waterarea_ha          lake_perimeter_m                ws_area_ha lake_lakes1ha_upstream_ha 
                0.3658960                 0.4044682                 0.3712166                 0.3975824 
 lake_lakes1ha_upstream_n 
                0.4646848 
[1] "Principal component 7"
              lm_slope_ppt avg_annual_range_temp_degC              dams_npersqkm 
                -0.3414416                 -0.2516631                 -0.2579439 
[1] "Principal component 8"
       lm_slope_temp nlcd_summed_agr_diff      avg_nlcd_ag_pct avg_nlcd_shrub52_pct        canals_mperha 
           0.2632541            0.4932867           -0.4300722            0.2537919            0.3044692 
[1] "Principal component 9"
      nlcd_summed_agr_diff       avg_nlcd_shrub52_pct   avg_nlcd_openwater11_pct lith_noncarbonateresid_pct 
                -0.2776792                  0.2799591                 -0.2505726                 -0.2646158 
               reliefratio 
                 0.3366986 

Add lake color to PC scores
```{r}
bg.fui = tibble(
...
abs((round(RY<-cor(lake_color)[,1][2:58],digits=2))) > 0.3 # only principle component 3 greater than 0.3
table(abs((round(RY<-cor(lake_color)[,1][2:58],digits=2))) > 0.3 )

```
Comp.1 Comp.2 Comp.3 Comp.4 Comp.5 Comp.6 Comp.7 Comp.8 Comp.9 
 -0.14  -0.61   0.27   0.16  -0.13  -0.07   0.06   0.11  -0.02 
...
png(paste0("/Users/jordanscheibe/Library/CloudStorage/OneDrive-UniversityofWyoming/Collaborations/LakeColor/LakeColor_SpatTem/Figures/Figure6/",Sys.Date(),"_Fig_6_lakecolor_vs_PCA.png"), width = 7, height=5, units = "in", res=400)
par(mar=c(3,3,1,1))
plot(lake_color$Comp.2,lake_color$avg_dwl_site, ylab = "", xlab= "",pch=16, col = lake_color$col_hex)
# add equation
text(16, (max(lake_color$avg_dwl_site)-2), 
...
text(16, (max(lake_color$avg_dwl_site)-9), 
     labels = bquote(R^2 == .(round(r_squared, 2))), 
        col = "black", cex = 1.2, adj=1)

text(16 , (max(lake_color$avg_dwl_site)-18), 
...
```
Call:
lm(formula = avg_dwl_site ~ Comp.2, data = lake_color)

Residuals:
    Min      1Q  Median      3Q     Max 
-60.830 -13.586   0.273  13.430  80.919 

Coefficients:
             Estimate Std. Error t value Pr(>|t|)    
(Intercept) 533.36932    0.06355  8392.3   <2e-16 ***
Comp.2       -5.28930    0.02386  -221.7   <2e-16 ***

Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 18.17 on 81737 degrees of freedom
Multiple R-squared:  0.3755,	Adjusted R-squared:  0.3755 
F-statistic: 4.914e+04 on 1 and 81737 DF,  p-value: < 2.2e-16

                 2.5 %     97.5 %
(Intercept) 533.244748 533.493882
Comp.2       -5.336069  -5.242536
...
```
             ...
             lake_elevation_m mean_totaldepnitrogen_kgperha 
                    0.2648562                    -0.2674495 
[1] "Principal component 2"
                    avg_ppt groundwaterrecharge_mmperyr              runoff_inperyr               soil_clay_pct       soil_orgcarbon_gperkg 
                  0.2552809                   0.2896867                   0.2947689                  -0.2628248                   0.2674841 
[1] "Principal component 3"
avg_nlcd_wetland_pct          soil_kffact        soil_sand_pct        soil_silt_pct   topographicwetness 
...
[1] "Principal component 6"
        lake_waterarea_ha          lake_perimeter_m                ws_area_ha lake_lakes1ha_upstream_ha  lake_lakes1ha_upstream_n 
               -0.3387945                -0.3663161                -0.2919574                -0.4155724                -0.4721371 
[1] "Principal component 7"
...
```
Comp.1 Comp.2 Comp.3 Comp.4 Comp.5 Comp.6 Comp.7 Comp.8 Comp.9 
 -0.27  -0.54   0.22   0.19  -0.17   0.03   0.03  -0.01   0.11 
...
png(paste0("/Users/jordanscheibe/Library/CloudStorage/OneDrive-UniversityofWyoming/Collaborations/LakeColor/LakeColor_SpatTem/Figures/Supplementary Figures/PCA_small_large/",Sys.Date(),"_Fig_6_lakecolor_vs_PCA_small.png"), width = 7, height=5, units = "in", res=400)
par(mar=c(3,3,1,1))
plot(lake_color$Comp.2,lake_color$avg_dwl_site, ylab = "", xlab= "",pch=16, col = lake_color$col_hex)
# add equation
text(14, (max(lake_color$avg_dwl_site)-2), 
     labels = bquote(y == .(round(summary_fit$coefficients[1,1], 2)) - .(round(abs(summary_fit$coefficients[2,1]), 2)) * x), 
      col = "black", cex = 1.2, adj=1)
# Add R-squared and p-value text
text(14, (max(lake_color$avg_dwl_site)-9), 
     labels = bquote(R^2 == .(round(r_squared, 2))), 
        col = "black", cex = 1.2, adj=1)

text(14, (max(lake_color$avg_dwl_site)-18), 
     labels = bquote(italic(P) == .(format.pval(p_value, digits = 2))), 
     col = "black", cex = 1.2, adj=1)
...
```
1] "Principal component 1"
                    avg_ppt mean_totaldepsulfur_kgperha       lm_slope_n_deposition       lm_slope_s_deposition 
                 -0.2728518                  -0.2796289                   0.2826333                   0.2645140 
[1] "Principal component 2"
        avg_nlcd_forest_pct groundwaterrecharge_mmperyr             soil_coarse_pct       soil_orgcarbon_gperkg                       tri_m 
                  0.2762545                   0.2891140                   0.3152736                   0.2643489                   0.2712627 
[1] "Principal component 3"
avg_nlcd_wetland_pct          soil_kffact        soil_sand_pct        soil_silt_pct   topographicwetness 
...
[1] "Principal component 6"
        lake_waterarea_ha          lake_perimeter_m                ws_area_ha lake_lakes1ha_upstream_ha  lake_lakes1ha_upstream_n 
                0.3120226                 0.3314295                 0.3020226                 0.3471272                 0.3855620 
[1] "Principal component 7"
[1] -0.3235967
[1] "Principal component 8"
nlcd_summed_agr_diff      avg_nlcd_ag_pct 
           0.5834398           -0.4987825 
[1] "Principal component 9"
      avg_nlcd_shrub52_pct lith_noncarbonateresid_pct      lith_silicicresid_pct              canals_mperha                reliefratio 
                 0.3644969                 -0.2717177                  0.2684283                  0.3067092                  0.2921993
...
Comp.1 Comp.2 Comp.3 Comp.4 Comp.5 Comp.6 Comp.7 Comp.8 Comp.9 
  0.20  -0.64   0.28   0.10  -0.09  -0.10   0.07   0.11   0.02 
...
png(paste0("/Users/jordanscheibe/Library/CloudStorage/OneDrive-UniversityofWyoming/Collaborations/LakeColor/LakeColor_SpatTem/Figures/Supplementary Figures/PCA_small_large/",Sys.Date(),"_Fig_6_lakecolor_vs_PCA_large.png"), width = 7, height=5, units = "in", res=400)
par(mar=c(3,3,1,1))
plot(lake_color$Comp.2,lake_color$avg_dwl_site, ylab = "", xlab= "",pch=16, col = lake_color$col_hex)
# add equation
text(15, (max(lake_color$avg_dwl_site)-2), 
     labels = bquote(y == .(round(summary_fit$coefficients[1,1], 2)) - .(round(abs(summary_fit$coefficients[2,1]), 2)) * x), 
      col = "black", cex = 1.2, adj=1)
# Add R-squared and p-value text
text(15, (max(lake_color$avg_dwl_site)-9), 
     labels = bquote(R^2 == .(round(r_squared, 2))), 
        col = "black", cex = 1.2, adj=1)

text(15, (max(lake_color$avg_dwl_site)-18), 
     labels = bquote(italic(P) == .(format.pval(p_value, digits = 2))), 
     col = "black", cex = 1.2, adj=1)
